...
export ANCHOR_PEER=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/crypto-config/k8sTest/HLF/channel-artifacts/Org1MSPanchors.tx
...
export ANCHOR_PEER=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/crypto-config/k8sTest/HLF/channel-artifacts/Org2MSPanchors.tx
export GENESIS_BLOCK=/opt/gopath/src/github.com/hyperledger/fabric/peer/crypto/crypto-config/k8sTest/HLF/channel-artifacts/orderer-channel.tx
export CLI_POD_ID=`kubectl get pod | grep cli | cut -f1 -d' '`
export ORDERER_ADDR="dev-orderer-g746q:7050"
